    ...
    return Obx(() {
      ...
      return Container(
        ...
        child: Container(
          ...
          child: StreamBuilder(
            stream: FirebaseFirestore.instance.collection('GioHang').where('maKhachHang',isEqualTo: FirebaseAuth.instance.currentUser!.uid).snapshots(),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(item.Ten,softWrap: true,style: const TextStyle(fontWeight: FontWeight.bold),),
                                Row(
