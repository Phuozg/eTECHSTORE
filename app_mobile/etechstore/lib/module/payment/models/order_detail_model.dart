...
class OrderDetail {
  ...
  Map<String, dynamic> toJson() {
    return {'MaDonHang': MaDonHang, 'KhuyenMai': KhuyenMai, 'SoLuong': SoLuong, 'TrangThai': TrangThai, 'MaMauSanPham': MaMauSanPham,'GiaTien':GiaTien};
  }

  factory OrderDetail.fromSnapshot(DocumentSnapshot<Map<String, dynamic>> document) {
    return OrderDetail(
      GiaTien: document['GiaTien']??0,
