    ...
    return Obx(() {
      ...
      return Column(
        children: [
                ...
                TextButton(
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (builder)=>ProductScreen(
                      title: 'Khuyến mãi',
                      query: FirebaseFirestore.instance.collection('SanPham').where('KhuyenMai',isGreaterThan: 0),
                    )));
                  }, 
              ...
              children: [
                ...
                TextButton(
                  onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (builder)=>ProductScreen(
                      title: 'Nổi bật',
                      query: FirebaseFirestore.instance.collection('SanPham').where('isPopular',isEqualTo: true),
                    )));
                }, 
                child: const Text("Xem tất cả"))
              ],  
          ...
          ElevatedButton(
            onPressed: (){
              Navigator.push(context, MaterialPageRoute(builder: (builder)=> ProductScreen(title: 'Tất cả sản phẩm',futureMethod: productController.getProductsForCate(catId: 0),)));
            }, 
